...
import {
	...
	REQUEST_USER_SEARCH_FETCH_SUCCEEDED,
	REQUEST_USERS_FETCH_SUCCEEDED,
	SET_SEARCHING_REQUEST_STATE,
...
const reducers = (state = defaultState, action) => {
	switch (action.type) {
		...
		case REQUEST_USER_SEARCH_FETCH_SUCCEEDED: {
			...
			return state
				.setIn([subStores.searching, 'totalCount'], fromJS(totalCount))
				.setIn([subStores.searching, 'items'], fromJS(items));
		}
