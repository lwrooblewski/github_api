...
import {
    requestUserSearchFetchFailed, requestUserSearchFetchSucceeded, setSearchingRequestState,
} from '../actions';
...
export default function* fetchSearchedUsers({ payload }) {
    try {
        ...
        const { data: { total_count: totalCount, items}} = yield call(useApi, apiMethod);
